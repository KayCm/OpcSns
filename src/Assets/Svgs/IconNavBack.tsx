...
function IconNavBack() {
    return(<Svg t="1773890228314" className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                p-id="6604" width="32" height="32">
        <Path
